...
import { OmitData, cn, getElevation, getFontSize, getWeights } from '../../utils/utils';
...
const Content: FunctionComponent<ContentProps> = ({ ...prop }) => {
    ...
    const classList = cn(ContentVariant({ family, weight, fontSize, elevation, className, defaultVariant }))
